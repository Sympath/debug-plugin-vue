# vue-debug-plugin | 在学习vue源码之后，我能做到什么
...
如果VueDevTool用得很快乐，也建议看看，本菜在实现插件过程中遇到很多问题，最后发现解决或优化方案居然大多来自于之前学习vue源码时的积累，不由得感觉持续学习的重要性,也希望能给些许小伙伴们坚持学习的动力，在这里暂举两个个人觉得比较有代表性的问题及解决
...
- 在数据变化导致后代组件装载卸载时，如`v-if`，我该如何监听到变化、并且重新构建插件？如果触发了多次组件装、卸载，我只希望重建一次，如何实现？
